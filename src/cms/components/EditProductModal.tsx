...
export function EditProductModal({ isOpen, onClose, onProductUpdated, product }: EditProductModalProps) {
  const [formData, setFormData] = useState({
    ...
    benefits: [] as string[], // Nouveau champ Bénéfices
  ...
  useEffect(() => {
    if (isOpen && product) {
      setFormData({
        ...
        currency: product.currency || 'FCFA', // Devise par défaut pour le marché ouest-africain
        ...
        features: product.features || '', // Nouveau champ Caractéristiques
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const productData: any = {
        ...
        currency: formData.currency, // Devise par défaut pour le marché ouest-africain
        ...
        benefits: formData.benefits || [], // Nouveau champ Bénéfices
