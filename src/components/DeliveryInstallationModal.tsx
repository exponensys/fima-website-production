...
import { faXmark, faTruck, faClock, faCheckCircle, faWrench } from "@fortawesome/free-solid-svg-icons";

interface DeliveryInstallationModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function DeliveryInstallationModal({
  isOpen,
  onClose,
}: DeliveryInstallationModalProps) {
      ...
      >
        ...
        <div className="p-8">
          <div className="mb-6">
            ...
            >
              FIMA Design vous offre un service complet de livraison et
              d'installation professionnelle pour tous vos meubles sur-mesure.
            </p>
          </div>
